...
?>
<div class="user-default-account text-center">
    ...
    <div class="small text-muted">Please enter your current password to edit your account</div>
    <?php endif ?>
    ...
    <?= $form->field($user->profile, 'full_name') ?>
